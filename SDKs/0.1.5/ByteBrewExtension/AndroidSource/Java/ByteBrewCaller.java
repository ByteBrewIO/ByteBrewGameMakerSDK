...
public class ByteBrewCaller {
    ...
    public void NewTrackedAdEventWithRevenue(String placementType, String adProvider, String adUnitName, double revenue)
    {
    ...
    public void NewTrackedAdEventWithAdLocationRevenue(String placementType, String adProvider, String adUnitName, String adLocation double revenue)
    {
